...
@current_app.route("/nlu/agents/<agent_name>/users/<userId>", methods=["GET"])
def get_user_inputs(agent_name, userId):
        ...
        users_inputs = []
        for user_input in AgentsService.get_instance().getUserInputs(agent_name, userId, max_confidence, min_confidence, page_number, page_size):
