...
def create_agent():
    ...
    if request.files:
        ...
        AgentsService.get_instance().create_agent(agent_name, 0, data.get("config"), data.get("nluData"), data.get("fallback"), data.get("responses"), data.get("currentVersion"))
        ...
        AgentsService.get_instance().create_agent(agent_name, 0, request_data.get("config"), request_data.get("nluData"), request_data.get("fallback"), request_data.get("responses"), request_data.get("currentVersion"))
    else:
