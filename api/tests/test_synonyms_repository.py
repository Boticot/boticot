...
import sys
sys.path.append(".")
import persistence.synonyms_repository as synonyms_repository
...
class TestSynonymsRepository:
    ...
    def mock_functions(self, mocker):
        mocker.patch("persistence.synonyms_repository.mongo")
        self.synonyms_repository = synonyms_repository.SynonymsRepository()
        mocker.patch("persistence.synonyms_repository.ObjectId")
    ...
    def test_should_return_false_when_insert_many_fails(self, mocker):
        mocker.patch("persistence.synonyms_repository.mongo.db.synonyms.insert_many", side_effect=Exception("Mock error"))
    ...
    def test_should_return_false_when_delete_one_fails(self, mocker):
        mocker.patch("persistence.synonyms_repository.mongo.db.synonyms.delete_one", side_effect=Exception("Mock error"))
    ...
    def test_should_return_false_when_update_one_fails(self, mocker):
        mocker.patch("persistence.synonyms_repository.mongo.db.synonyms.update_one", side_effect=Exception("Mock error"))
